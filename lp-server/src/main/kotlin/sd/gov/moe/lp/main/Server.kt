...
import sd.gov.moe.lp.common.auth.setupAuthenticators
import sd.gov.moe.lp.common.db.DatabaseConnector
import sd.gov.moe.lp.common.db.migrations.Migrations
import sd.gov.moe.lp.common.db.migrations.initializeUserMigrations
import sd.gov.moe.lp.common.exceptions.handleExceptions
import sd.gov.moe.lp.common.setupCommonRoutes
import sd.gov.moe.lp.deployment.LaunchConfig
import sd.gov.moe.lp.deployment.appConf
import sd.gov.moe.lp.domain.admin.setupAdminRoutes
import sd.gov.moe.lp.domain.client.setupClientRoutes
import sd.gov.moe.lp.domain.user.setupUserRoutes
import sd.gov.moe.lp.main.files.filesWithThumbnailsGenerator
import sd.gov.moe.lp.main.properties.VersionProperties
import sd.gov.moe.lp.main.provisioning.registerFirstAdmin
import io.ktor.http.*
